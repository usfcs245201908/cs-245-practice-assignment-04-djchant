...
public class Practice04Test {
	...
	protected String [] algorithms = {"insertionsort", "bubblesort", "selectionsort"}; // Algos to use.

	
	/**
	 * Default Constructor
	 */
	public Practice04Test() {
	 ...
	 * @param arraySize
	 */
	public Practice04Test(int arraySize) {
		populationStrategy = "random";
	 ...
	 */
	public Practice04Test(int arraySize, String populationStrategy) {
	...
	public static void main(String[] args) {
		...
		Practice04Test timing = new Practice04Test();
